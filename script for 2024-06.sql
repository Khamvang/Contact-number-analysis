...
-- 1) table contact_for  
create table `contact_for_202406_lcc` (
	  ...
	  constraint `contact_for_202406_lcc_ibfk_1` foreign key (`file_id`) references `file_details` (`id`)
) engine=InnoDB auto_increment=1 default CHARSET=utf8mb4 collate utf8mb4_general_ci ;


-- 2) intert data from contact_numbers_to_lcc to table monthly
insert into contact_for_202406_lcc
...
select count(*)  from contact_for_202406_lcc;  --  number need to delete becaues contracted or invalid number

delete from contact_for_202406_lcc
...
select branch_name , count(*)  from contact_for_202406_lcc group by branch_name ;

update contact_for_202406_lcc set branch_name = 'Bokeo' where branch_name is null;

select count(*) from contact_for_202406_lcc cfl -- 
...
select cfl.contact_id, t.`count_time` from contact_for_202406_lcc cfl
...
-- update
update contact_for_202406_lcc cfl
left join (select contact_id, count(*) `count_time` from contact_for_logcall group by contact_id) t on (cfl.contact_id = t.contact_id)
set cfl.`condition` = t.`count_time` ;

-- update the condition is null
select * from contact_for_202406_lcc where `condition` is null; -- 1,356,166
update contact_for_202406_lcc set `condition` = 1 where `condition` is null and status is not null; -- 1,335,744
update contact_for_202406_lcc set `condition` = 1 where `condition` is null and status is null; -- 422




# ______________________________________________________ export to create campaign on LCC for contact_for_202406_lcc ______________________________________________________________ #
...
-- Campaign name: all_new_ATTAPUE_ATP Team_20240601_p1 / all_new_ATTAPUE_ATP Team_20240601_p1-1
-- select count(*) -- 
...
-- Campaign name: 3_Old_ATTAPUE_ATP Team_20240601_p2 / 3_Old_ATTAPUE_ATP Team_20240601_p2-1
-- select count(*) -- 
select `id`,`contact_no`,`name`,`province_eng`,`province_laos`,`district_eng`,`district_laos`,`village`,`type`,`maker`,`model`,`year`,`remark_1`,`condition` `remark_2`,`remark_3`
from contact_for_202406_lcc cntl 
...
-- Campaign name: 2_Old_ATTAPUE_ATP Team_20240601_p3 / 2_Old_ATTAPUE_ATP Team_20240601_p3-1
-- select count(*) -- 
select `id`,`contact_no`,`name`,`province_eng`,`province_laos`,`district_eng`,`district_laos`,`village`,`type`,`maker`,`model`,`year`,`remark_1`,`condition` `remark_2`,`remark_3`
from contact_for_202406_lcc cntl 
...
-- Campaign name: 1_Old_ATTAPUE_ATP Team_20240601_p4  / 1_Old_ATTAPUE_ATP Team_20240601_p4-1
-- select count(*) -- 
select `id`,`contact_no`,`name`,`province_eng`,`province_laos`,`district_eng`,`district_laos`,`village`,`type`,`maker`,`model`,`year`,`remark_1`,`condition` `remark_2`,`remark_3`
from contact_for_202406_lcc cntl 
...
-- Campaign name: p_Old_ATTAPUE_ATP Team_20240601_p5 / p_Old_ATTAPUE_ATP Team_20240601_p5-1
-- select count(*) -- 
select `id`,`contact_no`,`name`,`province_eng`,`province_laos`,`district_eng`,`district_laos`,`village`,`type`,`maker`,`model`,`year`,`remark_1`,`condition` `remark_2`,`remark_3`
from contact_for_202406_lcc cntl 
...
-- Campaign name: 4_Old_ATTAPUE_ATP Team_20240601_p6  / 4_Old_ATTAPUE_ATP Team_20240601_p6-1
-- select count(*) -- 
select `id`,`contact_no`,`name`,`province_eng`,`province_laos`,`district_eng`,`district_laos`,`village`,`type`,`maker`,`model`,`year`,`remark_1`,`condition` `remark_2`,`remark_3`
from contact_for_202406_lcc cntl 
...
-- Campaign name: 4_Old_Head Office_Team2_20240601_p6 / 4_Old_Head Office_Team2_20240601_p6-1
