...
-- 1) table contact_for  
create table `contact_for_202401_lcc` (
	  ...
	  constraint `contact_for_202401_lcc_ibfk_1` foreign key (`file_id`) references `file_details` (`id`)
) engine=InnoDB auto_increment=1 default CHARSET=utf8mb4 collate utf8mb4_general_ci ;


-- 2) intert data from contact_numbers_to_lcc to table monthly
insert into contact_for_202401_lcc
...
select count(*)  from contact_for_202401_lcc;  --  number need to delete becaues contracted or invalid number

delete from contact_for_202401_lcc
...
select branch_name , count(*)  from contact_for_202401_lcc group by branch_name ;

update contact_for_202401_lcc set branch_name = 'Bokeo' where branch_name is null;

select count(*) from contact_for_202401_lcc cfl -- 
...
select * from contact_for_202401_lcc where `condition` is null; -- 1,356,166
update contact_for_202401_lcc set `condition` = 1 where `condition` is null and status is not null; -- 1,335,744
update contact_for_202401_lcc set `condition` = 1 where `condition` is null and status is null; -- 422




# ______________________________________________________ export to create campaign on LCC for contact_for_202401_lcc ______________________________________________________________ #
...
-- Campaign name: all_new_ATTAPUE_ATP Team_20240101_p1
-- select count(*) -- 
...
-- Campaign name: 2_Old_ATTAPUE_ATP Team_20240101_p3
-- select count(*) -- 
select `id`,`contact_no`,`name`,`province_eng`,`province_laos`,`district_eng`,`district_laos`,`village`,`type`,`maker`,`model`,`year`,`remark_1`,`remark_2`,`remark_3`
from contact_for_202401_lcc cntl 
...
-- Campaign name: 1_Old_ATTAPUE_ATP Team_20240101_p4
-- select count(*) -- 
select `id`,`contact_no`,`name`,`province_eng`,`province_laos`,`district_eng`,`district_laos`,`village`,`type`,`maker`,`model`,`year`,`remark_1`,`remark_2`,`remark_3`
from contact_for_202401_lcc cntl 
...
-- Campaign name: p_Old_ATTAPUE_ATP Team_20240101_p5
-- select count(*) -- 
select `id`,`contact_no`,`name`,`province_eng`,`province_laos`,`district_eng`,`district_laos`,`village`,`type`,`maker`,`model`,`year`,`remark_1`,`remark_2`,`remark_3`
from contact_for_202401_lcc cntl 
...
-- Campaign name: 4_Old_ATTAPUE_ATP Team_20240101_p6
-- select count(*) -- 
select `id`,`contact_no`,`name`,`province_eng`,`province_laos`,`district_eng`,`district_laos`,`village`,`type`,`maker`,`model`,`year`,`remark_1`,`remark_2`,`remark_3`
from contact_for_202401_lcc cntl 
...
-- ____________________________________________________ Priority6 ____________________________________________________
-- Campaign name: 4_Old_Head Office_Team2_20240101_p6
