...
WHERE LENGTH(contact_no) IN (11,12) and `date_created` between '2024-09-31' and '2024-10-31'; -- copy last date_created to here
...
where length(contact_no) in (11,12) and `date_created` between '2024-09-31' and '2024-10-31'; 
...
where -- status = 'ANSWERED' and communication_type = 'Outbound'
 ...
 and date_format(`time`, '%Y-%m-%d') between '2024-09-31' and '2024-10-31' -- please chcek this date from table all_unique_analysis
