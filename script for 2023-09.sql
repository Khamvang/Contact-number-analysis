...
-- 1) table contact_for  
create table `contact_for_202309_lcc` (
	  ...
	  constraint `contact_for_202309_lcc_ibfk_1` foreign key (`file_id`) references `file_details` (`id`)
) engine=InnoDB auto_increment=1 default CHARSET=utf8mb4 collate utf8mb4_general_ci ;


-- 2) intert data from contact_numbers_to_lcc to table monthly
insert into contact_for_202309_lcc
...
select count(*)  from contact_for_202309_lcc -- 4490751 number need to delete becaues contracted or invalid number
; delete from contact_for_202309_lcc
