...
select cfl.contact_id, t.`count_time` from contact_for_202312_lcc cfl
...
update contact_for_202312_lcc cfl
left join (select contact_id, count(*) `count_time` from contact_for_logcall group by contact_id) t on (cfl.contact_id = t.contact_id)
set cfl.`condition` = t.`count_time` ;

-- update the condition is null
select * from contact_for_202312_lcc where `condition` is null; -- 1,356,166
update contact_for_202312_lcc set `condition` = 1 where `condition` is null and status is not null; -- 1,335,744
update contact_for_202312_lcc set `condition` = 1 where `condition` is null and status is null; -- 422




# ______________________________________________________ export to create campaign on LCC for contact_for_202312_lcc ______________________________________________________________ #
...
-- Campaign name: all_new_ATTAPUE_ATP Team_20231201_p1
-- select count(*) -- 
...
from contact_for_202312_lcc cntl 
...
-- Campaign name: 3_Old_ATTAPUE_ATP Team_20231201_p2
-- select count(*) -- 
select `id`,`contact_no`,`name`,`province_eng`,`province_laos`,`district_eng`,`district_laos`,`village`,`type`,`maker`,`model`,`year`,`remark_1`,`remark_2`,`remark_3`
from contact_for_202312_lcc cntl 
...
-- Campaign name: 2_Old_ATTAPUE_ATP Team_20231201_p3
-- select count(*) -- 
select `id`,`contact_no`,`name`,`province_eng`,`province_laos`,`district_eng`,`district_laos`,`village`,`type`,`maker`,`model`,`year`,`remark_1`,`remark_2`,`remark_3`
from contact_for_202312_lcc cntl 
...
-- Campaign name: 1_Old_ATTAPUE_ATP Team_20231201_p4
-- select count(*) -- 
select `id`,`contact_no`,`name`,`province_eng`,`province_laos`,`district_eng`,`district_laos`,`village`,`type`,`maker`,`model`,`year`,`remark_1`,`remark_2`,`remark_3`
from contact_for_202312_lcc cntl 
...
-- Campaign name: p_Old_ATTAPUE_ATP Team_20231201_p5
-- select count(*) -- 
select `id`,`contact_no`,`name`,`province_eng`,`province_laos`,`district_eng`,`district_laos`,`village`,`type`,`maker`,`model`,`year`,`remark_1`,`remark_2`,`remark_3`
from contact_for_202312_lcc cntl 
...
-- Campaign name: 4_Old_ATTAPUE_ATP Team_20231201_p6
-- select count(*) -- 
select `id`,`contact_no`,`name`,`province_eng`,`province_laos`,`district_eng`,`district_laos`,`village`,`type`,`maker`,`model`,`year`,`remark_1`,`remark_2`,`remark_3`
from contact_for_202312_lcc cntl 
...
-- ____________________________________________________ Priority6 ____________________________________________________
-- Campaign name: 4_Old_Head Office_Team2_20231201_p6
