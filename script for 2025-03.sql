...
-- 1) table contact_for  
create table `contact_for_202503_lcc` (
...
select count(*)  from contact_for_202503_lcc;  --  number need to delete becaues contracted or invalid number

delete from contact_for_202503_lcc
...
select branch_name , count(*)  from contact_for_202503_lcc group by branch_name ;

update contact_for_202503_lcc set branch_name = 'Bokeo' where branch_name is null;

select count(*) from contact_for_202503_lcc cfl -- 
...
select '2025-02-28' `date`, `contact_no`, `contact_id`, `remark_2`, `status_updated`
from contact_for_202502_lcc cfl where status_updated is not null;


-- 7) check and update logcall 
select cfl.contact_id, t.`count_time` from contact_for_202503_lcc cfl
...
-- update
update contact_for_202503_lcc cfl
left join (select contact_id, count(*) `count_time` from contact_for_logcall group by contact_id) t on (cfl.contact_id = t.contact_id)
set cfl.`condition` = t.`count_time` ;

-- update the condition is null
select * from contact_for_202503_lcc where `condition` is null; -- 1,356,166
update contact_for_202503_lcc set `condition` = 1 where `condition` is null and status is not null; -- 1,335,744
...
-- Campaign name: 11_Old_Attapue_ATP Team_20250301 / 11_Old_Attapue_ATP Team_20250301
-- select count(*) -- 
...
from contact_for_202503_lcc cntl 
...
-- Campaign name: 12_Old_Attapue_ATP Team_20250301 / 12_Old_Attapue_ATP Team_20250301
-- select count(*) -- 
select `id`,`contact_no`,`name`,`province_eng`,`province_laos`,`district_eng`,`district_laos`,`village`,`type`,`maker`,`model`,`year`,`remark_1`,`condition` `remark_2`,`remark_3`
from contact_for_202503_lcc cntl 
...
-- Campaign name: 13_Old_Attapue_ATP Team_20250301 / 13_Old_Attapue_ATP Team_20250301
-- select count(*) -- 
select `id`,`contact_no`,`name`,`province_eng`,`province_laos`,`district_eng`,`district_laos`,`village`,`type`,`maker`,`model`,`year`,`remark_1`,`condition` `remark_2`,`remark_3`
from contact_for_202503_lcc cntl 
...
-- Campaign name: 14_Old_Attapue_ATP Team_20250301 / 14_Old_Attapue_ATP Team_20250301
-- select count(*) -- 
select `id`,`contact_no`,`name`,`province_eng`,`province_laos`,`district_eng`,`district_laos`,`village`,`type`,`maker`,`model`,`year`,`remark_1`,`condition` `remark_2`,`remark_3`
from contact_for_202503_lcc cntl 
...
-- Campaign name: 15_Old_Attapue_ATP Team_20250301 / 15_Old_Attapue_ATP Team_20250301
-- select count(*) -- 
select `id`,`contact_no`,`name`,`province_eng`,`province_laos`,`district_eng`,`district_laos`,`village`,`type`,`maker`,`model`,`year`,`remark_1`,`condition` `remark_2`,`remark_3`
from contact_for_202503_lcc cntl 
...
-- Campaign name: 16_Old_Attapue_ATP Team_20250301 / 16_Old_Attapue_ATP Team_20250301
-- select count(*) -- 
select `id`,`contact_no`,`name`,`province_eng`,`province_laos`,`district_eng`,`district_laos`,`village`,`type`,`maker`,`model`,`year`,`remark_1`,`condition` `remark_2`,`remark_3`
from contact_for_202503_lcc cntl 
...
-- Campaign name: 17_Old_Attapue_ATP Team_20250301 / 17_Old_Attapue_ATP Team_20250301
-- select count(*) -- 
select `id`,`contact_no`,`name`,`province_eng`,`province_laos`,`district_eng`,`district_laos`,`village`,`type`,`maker`,`model`,`year`,`remark_1`,`condition` `remark_2`,`remark_3`
from contact_for_202503_lcc cntl 
...
-- Campaign name: 18_Old_Attapue_ATP Team_20250301 / 18_Old_Attapue_ATP Team_20250301
-- select count(*) -- 
select `id`,`contact_no`,`name`,`province_eng`,`province_laos`,`district_eng`,`district_laos`,`village`,`type`,`maker`,`model`,`year`,`remark_1`,`condition` `remark_2`,`remark_3`
from contact_for_202503_lcc cntl 
...
-- Campaign name: 19_Old_Attapue_ATP Team_20250301 / 1_Old_Attapue_ATP Team_20250301
-- select count(*) -- 
select `id`,`contact_no`,`name`,`province_eng`,`province_laos`,`district_eng`,`district_laos`,`village`,`type`,`maker`,`model`,`year`,`remark_1`,`condition` `remark_2`,`remark_3`
from contact_for_202503_lcc cntl 
