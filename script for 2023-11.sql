...
-- 1) table contact_for  
create table `contact_for_202311_lcc` (
...
# ______________________________________________________ export to create campaign on LCC for contact_for_202311_lcc ______________________________________________________________ #
...
-- Campaign name: all_new_ATTAPUE_ATP Team_20231101_p1
-- select count(*) -- 
...
from contact_for_202311_lcc cntl 
...
-- Campaign name: 3_Old_ATTAPUE_ATP Team_20231101_p2
-- select count(*) -- 
select `id`,`contact_no`,`name`,`province_eng`,`province_laos`,`district_eng`,`district_laos`,`village`,`type`,`maker`,`model`,`year`,`remark_1`,`remark_2`,`remark_3`
from contact_for_202311_lcc cntl 
...
-- Campaign name: 2_Old_ATTAPUE_ATP Team_20231101_p3
-- select count(*) -- 
select `id`,`contact_no`,`name`,`province_eng`,`province_laos`,`district_eng`,`district_laos`,`village`,`type`,`maker`,`model`,`year`,`remark_1`,`remark_2`,`remark_3`
from contact_for_202311_lcc cntl 
...
-- Campaign name: 1_Old_ATTAPUE_ATP Team_20231101_p4
-- select count(*) -- 
select `id`,`contact_no`,`name`,`province_eng`,`province_laos`,`district_eng`,`district_laos`,`village`,`type`,`maker`,`model`,`year`,`remark_1`,`remark_2`,`remark_3`
from contact_for_202311_lcc cntl 
...
-- Campaign name: p_Old_ATTAPUE_ATP Team_20231101_p5
-- select count(*) -- 
select `id`,`contact_no`,`name`,`province_eng`,`province_laos`,`district_eng`,`district_laos`,`village`,`type`,`maker`,`model`,`year`,`remark_1`,`remark_2`,`remark_3`
from contact_for_202311_lcc cntl 
...
-- Campaign name: 4_Old_ATTAPUE_ATP Team_20231101_p6
-- select count(*) -- 
select `id`,`contact_no`,`name`,`province_eng`,`province_laos`,`district_eng`,`district_laos`,`village`,`type`,`maker`,`model`,`year`,`remark_1`,`remark_2`,`remark_3`
from contact_for_202311_lcc cntl 
...
-- ____________________________________________________ Priority6 ____________________________________________________
-- Campaign name: 4_Old_Head Office_Team2_20231101_p6
